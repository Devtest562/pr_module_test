...
local result = engine.load_library("pr_module_test")
if(result ~= true) then
    -- Module failed to load
    console.print_warning("Failed to load \"Test Project\" module: " .. r)
    return
end

-- The default module defines several demo Lua bindings in "src/pr_module.cpp", we can call them like so:
pr_module_test.print()

local d = pr_module_test.DemoClass()
